package Assignment1.stream.com;

import java.util.ArrayList;
import java.util.Comparator;
import java.util.stream.Collectors;

public class Fruitcalories {
public static void main(String[] args) {
		
		Fruit fruit1=new Fruit("Orange", 101, 50, "Orange");
		Fruit fruit2=new Fruit("Banana", 5, 40, "Yellow");
		Fruit fruit3=new Fruit("Mango", 20, 70, "Orange");
		Fruit fruit4=new Fruit("Watermelon", 25, 30, "Green");
		Fruit fruit5=new Fruit("Apple", 111, 80, "red");
		
		Fruit fruit6=new Fruit("Cherry", 85, 100, "Red");
